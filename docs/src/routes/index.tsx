      ...
      <div className='min-h-screen py-20'>
        <div className='container mx-auto grid grid-cols-1 px-4 mb-10 sm:px-6 lg:grid-cols-2 lg:px-8'>
          <div className='pt-6 lg:pt-24'>
            ...
            <p className='mx-auto mt-3 max-w-md text-base text-fd-muted-foreground sm:text-lg md:mt-5 md:max-w-3xl md:text-xl'>
              A lightweight, framework-agnostic, type-safe permissions management library for
        ...
        <div className='container mx-auto relative z-10 grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 lg:gap-8'>
          {[
            ...
            <div
              key={item.title}
              className='space-y-2 rounded-lg border border-fd-border bg-fd-card p-4 shadow-sm sm:rounded-xl sm:p-6 lg:rounded-3xl lg:p-8'
            >
