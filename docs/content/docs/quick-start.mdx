...
1. Detect my stack (framework(s), server/client split, e.g. React, Vue, Solid,
   Svelte, Next.js, TanStack Start, Nuxt, React Router, Astro, Nest, Node, Hono,
   Express, tRPC, oRPC, Fastify, Elysia, Drizzle, Better Auth, Clerk, Supabase,
   Convex) and install `permix` plus the matching integration from
   https://permix.letstri.dev/docs/guide/choose-adapter.
...
- [Choose an adapter](/docs/guide/choose-adapter) — which `permix/*` import to use
- [Security](/docs/guide/security) — client checks are UX only
...
Pick the matching page, or start from [Choose an adapter](/docs/guide/choose-adapter).
...
<Card href="/docs/integrations/react-router" title="React Router">
...
<Card href="/docs/integrations/standard-schema" title="Standard Schema">
...
<Card href="/docs/integrations/nest" title="NestJS">
  Guard and @Check decorator.
</Card>

<Card href="/docs/integrations/pdp" title="HTTP PDP">
  Fetch-standard policy decision point.
</Card>

<Card href="/docs/integrations/better-auth" title="Better Auth">
  Server and client permission plugins.
</Card>

<Card href="/docs/integrations/clerk" title="Clerk">
  Session and organization-aware rules.
</Card>

<Card href="/docs/integrations/supabase" title="Supabase">
  Verified identity, optional RLS mapping.
</Card>

<Card href="/docs/integrations/convex" title="Convex">
  Isolated checks on queries, mutations, and actions.
</Card>
