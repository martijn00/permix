...
Prefer a generated catalog: mark paths with `permission()`, run `pnpm permix extract`, then `createPermix<Definition>()`. See [Permission extraction](/docs/guide/extraction).
